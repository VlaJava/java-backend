...
public interface BookingControllerSwagger {
    ...
    @Operation(summary = "Get all bookings (admin)", description = "Returns a paginated list of all bookings for Admin Panel.")
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all bookings for user", description = "Returns a paginated list of bookings for My Bookings.")
    @ApiResponses(value = {
